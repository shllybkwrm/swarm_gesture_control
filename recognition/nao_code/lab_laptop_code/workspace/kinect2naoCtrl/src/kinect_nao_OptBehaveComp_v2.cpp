...
void updateOutputAngles()
{
	...
	if(!(weights_LSP.empty()))
	{
		...
		OutputJointAngles.push_back(desired_LSP);	
		OutputJointNames.push_back("LShoulderRoll");
		OutputJointAngles.push_back(desired_LSR);
		OutputJointNames.push_back("LElbowYaw");
		OutputJointAngles.push_back(desired_LEY);
		OutputJointNames.push_back("LElbowRoll");
		OutputJointAngles.push_back(desired_LER);
		OutputJointNames.push_back("RShoulderPitch");
		OutputJointAngles.push_back(desired_RSP);	
		OutputJointNames.push_back("RShoulderRoll");
		OutputJointAngles.push_back(desired_RSR);
		OutputJointNames.push_back("RElbowYaw");
		OutputJointAngles.push_back(desired_REY);
		OutputJointNames.push_back("RElbowRoll");
		OutputJointAngles.push_back(desired_RER);
